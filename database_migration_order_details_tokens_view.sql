-- Adds reward-token payment fields to the order details view used by GroovevieSoftware.
...
SELECT
    ...
    o.payment_status,
    o.total_amount,
    COALESCE(o.token_payment_amount, 0) as token_payment_amount,
    COALESCE(o.tokens_redeemed, false) as tokens_redeemed,
...
GROUP BY
    ...
    o.token_payment_amount, o.tokens_redeemed,
