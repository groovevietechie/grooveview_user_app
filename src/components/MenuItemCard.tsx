...
export default function MenuItemCard({ item, themeColor, orderCount = 0 }: MenuItemCardProps) {
  ...
  return (
    <>
      <div className="lounge-product-card menu-card relative bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 group">
        {item.image_url ? (
