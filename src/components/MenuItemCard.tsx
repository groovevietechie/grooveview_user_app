      ...
      <div className="menu-card-content p-4">
        ...
        <div className="menu-card-actions space-y-3">
          ...
          <button
            ...
            className="w-full font-bold py-2.5 px-3 rounded-lg disabled:cursor-not-allowed transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] hover:shadow-md disabled:hover:scale-100 disabled:hover:shadow-none text-sm"
          >
